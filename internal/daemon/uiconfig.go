...
func toAPIUIConfig(c config.UIConfig) api.UIConfig {
	out := api.UIConfig{CollapseParents: c.CollapseParents, CwdRoots: c.CwdRoots, TranscriptPrefetchSecs: c.TranscriptPrefetchSecs, MasterCommand: c.MasterCommand, DefaultAgent: c.DefaultAgent, DefaultMachine: c.DefaultMachine, DefaultChatView: c.DefaultChatView, ExtraKeys: c.ExtraKeys}
...
func fromAPIUIConfig(c api.UIConfig) config.UIConfig {
	out := config.UIConfig{CollapseParents: c.CollapseParents, CwdRoots: c.CwdRoots, TranscriptPrefetchSecs: c.TranscriptPrefetchSecs, MasterCommand: c.MasterCommand, DefaultAgent: c.DefaultAgent, DefaultMachine: c.DefaultMachine, DefaultChatView: c.DefaultChatView, ExtraKeys: c.ExtraKeys}
	for _, r := range c.CwdLabels {
