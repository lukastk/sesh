...
**This file now has TWO parts**, appended in the order they were archived: Part 1 below
(H1-H33, the June 2026 build-out, archived 2026-08-22) and **ARCHIVE PART 2** further down
(H34-H90, the July-August 2026 entries, archived 2026-09-17). Neither part is imported into
agent context; the live `AGENTS.local.md` holds H91 onwards.
...
~90K tokens of two-month-old, fully-deployed history — the live-file guidance is "read
the last few entries". Nothing was lost: these entries are here in full and in git
history, the durable design lessons live in the live file's "Reference" section, and the
still-cross-referenced traps (H22, H25, H30, H33, the WHICH-CLIENT LAW, the termux
relaunch recipe) are summarised in the live file's "Trap digest". This file is NOT
imported into agent context.

Entries are in rough chronological order: H1-H9 + the foundational laws (Jun 10-12),
H10-H22 (Jun 13-18), H23-H29 + H33 (Jun 24-29), H30-H32 (Jun 29).
...
# AGENTS.local.md - ARCHIVE PART 2 (July-August 2026)

The H34-H90 working-log entries, covering 2026-07-02 -> 2026-08-23. Moved here out of
`AGENTS.local.md` on 2026-09-17, for the same reason as Part 1 above: a docs audit found the
live log had grown to ~491 KB (~120K tokens), and it is imported into every agent session in
this repo via `@AGENTS.local.md`, so every session was paying for two months of
fully-deployed history. The live file is ~207 KB after the move. Nothing was lost: these
entries are here in full and in git history, and the live file keeps H91 onwards plus its
"Trap digest" and "Reference" sections, which already distil the durable lessons. This file
is NOT imported into agent context.

Entries keep the live file's original order and bytes exactly. That order is
reverse-chronological by position rather than by number: H90 down to H34 (2026-08-23 ->
2026-07-02), then a trailing block of H50-H55 (2026-07-23 -> 2026-07-24). Those last six sat
BELOW the "Trap digest"/"Reference" sections at the very bottom of the live file - an
artefact of how they were appended there, not a meaning - so they arrive here as their own
trailing block rather than being re-sorted into the sequence. Note also a pre-existing
numbering collision carried over verbatim: H89 names two different entries, both below. (The
live file's other collision, the two H104s, stayed behind with the recent entries.)
